...
tables[1] = new Table( 1, 'Beginner Table', eventEmitter(1), 6, 200, 100, 3000, 200, false );
tables[2] = new Table( 2, 'Amateur Table', eventEmitter(2), 6, 400, 200, 10000, 160, false );
tables[3] = new Table( 3, 'Professional Table', eventEmitter(3), 6, 500, 300, 20000, 40, false );
